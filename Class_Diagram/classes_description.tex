...
\subsection{HealthMaxxinSystem}\label{sec:1-healthmaxxinsystem}
...
\subsection{User}\label{sec:2-user}
...
\subsection{Patient}\label{sec:3-patient}
...
\subsection{Doctor}\label{sec:4-doctor}
...
\subsection{HeadOfDepartment}\label{sec:5-headofdepartment}
...
\subsection{HeadOfHospital}\label{sec:6-headofhospital}
...
\subsection{SystemAdmin}\label{sec:7-systemadmin}
...
\subsection{Hospital}\label{sec:8-hospital}
...
\subsection{Department}\label{sec:9-department}
...
\subsection{Shift}\label{sec:10-shift}
...
\subsection{Calendar}\label{sec:11-calendar}
...
\subsection{TemporaryPassword}\label{sec:12-temporarypassword}
...
\subsection{Appointment}\label{sec:13-appointment}
...
\subsection{Payment}\label{sec:14-payment}
...
\subsection{Treatment}\label{sec:15-treatment}
...
\subsection{TreatmentCatalog}\label{sec:16-treatmentcatalog}
...
\subsection{Prescription}\label{sec:17-prescription}
...
\subsection{Exemption}\label{sec:18-exemption}
...
\subsection{InsurancePolicy}\label{sec:19-insurancepolicy}
...
\subsection{InsurancePolicyRecord}\label{sec:20-insurancepolicyrecord}
...
\subsection{OutstandingDebt}\label{sec:21-outstandingdebt}
...
\subsection{AiAssistant}\label{sec:22-aiassistant}
...
\subsection{MailService}\label{sec:23-mailservice}
