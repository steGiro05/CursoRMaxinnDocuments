...
\fancyhead[R]{Deliverable 3 -- Architecture, User Flows, Code development} % Top right
...
% \includeonly{sections/07_code-dev}
...
\include{sections/00_purpose}
\include{sections/01_d1-modifications}
\include{sections/02_d2-modifications}
\include{sections/03_context-description}
\include{sections/04_architecture}
\include{sections/05_use-cases-impl}
\include{sections/06_user-flows}
\include{sections/07_code-dev}
\include{sections/08_self-eval}
