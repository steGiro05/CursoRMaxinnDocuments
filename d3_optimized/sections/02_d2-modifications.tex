...
\begin{ucrequirements}
    FR11.1 & Patient registration \\ \hline
    FR11.2 & Patient validation \\ \hline
...
\begin{ucflow}
    ...
    2 & The Patient submits personal information together with the password. \\ \hline
    3 & The Unregistered Patient submits. \\ \hline
    4 & The System validates the input fields. \\ \hline
    6 & The System creates a new unverified account in the Database. \\ \hline
    7 & The System sends a verification token to the provided email address via the Mail Service. \\ \hline
    8 & The User accesses their mailbox and clicks on the validation link. \\ \hline
    9 & The System retrieves the validation token sent with the request. \\ \hline
    10 & The System checks for token validity and matching records in the Database. \\ \hline
    11 & The System marks the account as verified and active. \\ \hline
\end{ucflow}
...
\begin{ucextensions}
    ...
    4b & \textbf{Email already taken:}\newline 
         1. The System finds another account already associated with the  email. \newline 
         2. The Patient is prompted with an error message suggesting to log in or reset the password. \newline 
         3. Use case ends. \\ \hline

    4c & \textbf{Password security check fails:}\newline 
...
In EXTENSIONS, step 10a, removed the possibility to recieve a new validation email.
\end{ucedits}
...
\begin{ucflow}
    ...
    2 & The System filters Doctors assigned to the requested hospital. \\ \hline
...
\begin{ucflow}
    1 & The Patient selects the desired examination and a preferred hospital, department and a target future date. \\ \hline
...
\begin{ucextensions}
    2a & \textbf{Hospital does not offer the requested examination:}\newline 
         1. The System displays an error message asking the Patient to select another hospital, department or examination. \newline 
         2. Resume at Main Flow Step 1. \\ \hline

    4a & \textbf{No suitable appointment is found:}\newline 
         1. The System displays an error message asking the Patient to select another hospital, department and date range. \newline 
         2. Resume at Main Flow Step 1. \\ \hline
