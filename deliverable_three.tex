...
Ehy<3
\section{User Flows}
General explanation on colors and shapes used
\\\\
% --- eg ---
\begin{minipage}{\textwidth}
    \subsection{UF1. Admin Login}
    The following user flows shows the process of admin login.
    Da specificare i metodi del class diagram e gli uc che copre
    \\\\
    \begin{center}
