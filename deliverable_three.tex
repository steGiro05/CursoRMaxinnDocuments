...
We implemented....., in order to give a complete overview of the main functionalities of the HealthMaxxing app.
...
\begin{minipage}{\textwidth}
    ...
    The following diagram describes in detail the steps of the general Fill Form flow, expandend in the user flow "metter link".
    \\\\
    \begin{center}
...
\begin{minipage}{\textwidth}
    \subsection{UF14. Patient - Medical Record, Prescriptions, Exemptions consultation}
