...
based on their relevance to the user flows described above. Each group highlights a meaningful 
...
\begin{minipage}{\textwidth}
    ...
    The following diagram describes in detail the steps of the general Detailed Access flow, expandend in the user flow \hyperref[UF16]{UF16. Patient - Medical Record and Prescriptions consultation}.
...
\begin{minipage}{\textwidth}
    ...
    It refers to use case \textbf{UC5, UC6}, and methods \textbf{InsurancePolicy.edit(policy, newPolicyData), Hospital.edit(hospital, newHospitalData), Treatment.edit(treatment, newTreatmentData), Department.edit(department, newDepartmentData)} from the classes \textbf{InsurancePolicy, Hospital, Treatment, Department} of the class diagram.
...
\begin{minipage}{\textwidth}
    ...
    It refers to use case \textbf{UC8, UC9}, and methods \textbf{InsurancePolicy.deactivate(policy), Hospital.close(), Treatment.deactivate(), Department.close()} from the classes \textbf{InsurancePolicy, Hospital, Treatment, Department} of the class diagram.
...
\begin{minipage}{\textwidth}
    ...
    It refers to use case \textbf{UC10, UC29}, and methods \textbf{cancel(), reschedule(newDateTime)} from the class \textbf{Appointment} of the class diagram.
...
\begin{minipage}{\textwidth}
    ...
    It refers to use case \textbf{UC27, UC32}, and methods \textbf{Appointment.book(treatment,hospital,datetime), Payment.pay(paymentData)} from the classes \textbf{Appointment, Payment} of the class diagram.
...
\begin{minipage}{\textwidth}
    ...
    It refers to use case \textbf{UC38, UC39, UC40}, and methods \textbf{Patient.getPrescriptions(), Prescription.getDetails(), Patient.getMedicalRecord()} from the classes \textbf{Patient, Prescription} of the class diagram.
...
\begin{minipage}{\textwidth}
    ...
    It refers to use case \textbf{UC42, UC43}, and methods \textbf{accessPatientRecord(fiscalCode),viewChronologicalReport()} from the class \textbf{Doctor} of the class diagram.
...
\begin{minipage}{\textwidth}
    ...
    It refers to use case \textbf{UC3, UC4}, and methods \textbf{Prescription.create(prescriptionData), Exemption.create(exemptionData), Examination.create(examinationData)} from the classes \textbf{Prescription, Exemption, Examination} of the class diagram.
...
\begin{minipage}{\textwidth}
    \phantomsection
    \subsection{UF18. Doctor - Cancel Appointment}
...
\begin{minipage}{\textwidth}
    \phantomsection
    \subsection{UF19. Head of Department - Management Operations}
    ...
    It refers to use case \textbf{UC17, UC21, UC44}, and methods \textbf{updateDepartmentTreatments(newTreatments), configureDepartmentCapacity(newCapacity),  setShiftPattern(Doctor, Shifts)} from the class \textbf{Head of Department} of the class diagram.
...
\phantomsection
\subsection{UF20. Head of Department - Cancel Department Appointments}
...
\begin{minipage}{\textwidth}
    \phantomsection
    \subsection{UF21. Head of Hospital - Insurances' Debt Management}
    ...
    It refers to use case \textbf{UC18, UC19, UC20}, and methods \textbf{Hospital.getInsuranceDebt(), OutstandingDebt.getHistory(),OutstandingDebt.settle(amount), } from the classes \textbf{Hospital, OutstandingDebt} of the class diagram.
...
\begin{minipage}{\textwidth}
    \phantomsection
    \subsection{UF22. Head of Hospital - Department Assignments Management}
    ...
    It refers to use case \textbf{UC13, UC15}, and methods \textbf{appointHeadOfDepartment(doctor, dept), allocateDoctors(doctors, dept )} from the class \textbf{Head of Hospital} of the class diagram.
