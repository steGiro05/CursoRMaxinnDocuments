...
\begin{minipage}{\textwidth}
    ...
    It refers to use case \textbf{UC27, UC32, UC35}, and methods \textbf{bookAppointment(), ??} from the class \textbf{Patient} of the class diagram.
...
\begin{minipage}{\textwidth}
    ...
    \begin{center}
        \includegraphics[width=0.6\textwidth]{User_Flows/DoctorAppointmentCancellation.png}
...
\begin{minipage}{\textwidth}
    ...
    \begin{center}
        \includegraphics[width=0.6\textwidth]{User_Flows/DepartmentAppointmentCancellation.png}
