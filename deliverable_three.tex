...
The system shall enable users to manage their platform identity and access through the following functionalities:
\begin{itemize}
...
The term "User" has been replaced with "Patient" to ensure consistency across the entire specification. The system domain is patient-centric, and account registration/validation applies exclusively to patients rather than generic users.
...
\begin{minipage}{\textwidth}
    ...
    \begin{itemize}
        ...
        \textbf{UC4}{Upload Examination},    \end{itemize}
\end{minipage}
\vspace{3em}
