...
% The [normalem] option is very important! It stops ulem from 
% changing your standard italicized text (\emph{}) into underlines.
...
\begin{titlepage}
    ...
    % --- DOCUMENT TYPE ---
    {\scshape\Large Functionalities Analysis\par}
    \vspace{0.2cm}
