...
\begin{itemize}
    ...
    \item \hl{\textbf{FR9.4 Deactivate Insurance Policy:} The system shall allow the System Administrator to deactivate an existing insurance policy.}
\end{itemize}
\nameref{O2}
\\
\\ \textbf{Edit}:
\hl{Following the review of D1, the functional requirement was split into Create Insurance Policy, View Insurance Policies, Update Insurance Policy, Deactivate Insurance Policy with the goal of achieving a more detailed description of such actions.}
...
\usecaseheader
  ...
  {Scope: Managing insurance. Level: Primary.} % 4: Scope
  {The user is logged in as the Head of Hospital. An outstanding debt is present, and the insurance company has paid out the debt.} % 5: Preconditions
