...
A specialization of \texttt{User} representing individuals who seek and receive medical care within the system. Patients are the primary consumers of healthcare services: they book appointments for treatments, manage their insurance coverage, and accumulate a health history made up of prescriptions, examinations, and exemptions. The \texttt{fiscalCode} inherited from \texttt{User} is especially important for patients, as it is the key used by doctors to access their medical records.
...
\begin{itemize}
    ...
    \item Is notified by \texttt{MailService} for appointments, prescriptions, exemptions, and examinations
\end{itemize}
...
\begin{itemize}
    ...
    \item Appointments are located at a hospital (via the "Located at" association on \texttt{Appointment})
...
\begin{itemize}
    ...
    \item Paid via 0..N \texttt{Payment} records
